...
type
  TfrmNotaDados = class(TfrmFormPadrao)
    ...
    dbgridItensDBTableView1nItem: TcxGridDBColumn;
...
//    pcNotas.ActivePage := tsDadosNota;
  ...
  begin
    ...
    frmNotaItem.idPessoa := qryCadastroidPessoa.AsInteger;
    frmNotaItem.idNota := qryCadastroidNota.AsInteger;
...
begin
  ...
  try
    qryCadastroidNota.AsInteger := dmCaixa.RetornaValorSequence('[Contabil].[NotasSequence]');
  except
    on e : exception do
